...
export default function NewFighter({ onCreated }) {
    ...
    return (
        <div id="new-fighter">
            ...
            <TextField onChange={onNameChange} id="standard-basic"
            label="Standard" placeholder="Name"/>

            <TextField onChange={onPowerChange} id="standard-basic"
            label="Standard" placeholder="Power" type="number" />
